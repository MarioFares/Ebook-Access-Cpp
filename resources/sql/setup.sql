...
(
    ...
    "status" INTEGER NOT NULL DEFAULT 0 CHECK
(
    status >
    -
    1
    ...
    "time_added" DATETIME NOT NULL DEFAULT
(
    Datetime
(
    CURRENT_TIMESTAMP,
...
SELECT tags.m_name   AS tag,
       ebooks.m_name AS ebook
FROM tags
...
SELECT links.m_name AS link,
       links.path   AS path,
       lc.m_name    AS collection
FROM links
