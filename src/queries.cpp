...
namespace queries {
    ...
    void selectSearchesTable() {
        query.exec("SELECT id AS ID, "
            ...
            "status AS Status, "
            "date_published AS 'Date Published', "
            "size_from AS 'From Size', "
            "size_to AS 'To Size', "
            "size_in AS 'Size Unit', "
            "pages_from AS 'From Pages', "
            "pages_to AS 'To Pages', "
            "timestamp AS 'Date Added' "
            "FROM searches");
    }
    ...
    void insertBooksQuery(QString name, QString path, QString folder, QString ext, quint64 size,
                          quint32 pages, QString tags, QString genre, QString author, QString publisher,
                          QString published,
