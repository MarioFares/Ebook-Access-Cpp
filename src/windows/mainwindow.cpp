...
void MainWindow::setupConnections() {
    ...
    connect(m_buttonSummaries, &QToolButton::clicked, [] { showSummary(""); });
    ...
    connect(m_actionBookDetails, &QAction::triggered, [] { showBookDetailsWindow(""); });
    ...
    connect(m_actionSummaries, &QAction::triggered, [] { showSummary(""); });
